...
const skillCategories = {
  Frontend: [
    ...
    { name: 'JavaScript', percent: 85, icon: 'devicon-javascript-plain colored' },
    { name: 'React.js', percent: 82, icon: 'devicon-react-original colored' },
    { name: 'Tailwind CSS', percent: 88, icon: 'devicon-tailwindcss-plain colored' },
    { name: 'Bootstrap', percent: 88, icon: 'devicon-bootstrap-plain colored' },
    { name: 'TypeScript', percent: 30, icon: 'devicon-typescript-plain colored' },
  ...
  Database: [
    ...
    { name: 'PostgreSQL', percent: 60, icon: 'devicon-postgresql-plain colored' },
        ...
        >
          ...
          <motion.div variants={fadeLeft} className="flex-1 space-y-6">
            ...
            <p className="text-gray-500 dark:text-gray-400 max-w-lg leading-relaxed">
              ...
              <span className="text-red-500 font-bold">2+</span> years of experience
              building through clean code and thoughtful design.
            </p>
          ...
          {/* Right — Image */}
          <motion.div variants={fadeRight} className="flex-1 flex justify-center">
